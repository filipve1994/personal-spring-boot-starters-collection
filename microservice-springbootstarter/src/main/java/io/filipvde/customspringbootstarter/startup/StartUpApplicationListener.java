 ...
 */
//TODO need further finetuning and need a conditional expression to only use when activated; lookup how to do this
@Component
@Order(0)
public class StartUpApplicationListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    @Value("${app.startupinfo.startupLogMessageSuccess:FVE-COMPONENT STARTED}")
